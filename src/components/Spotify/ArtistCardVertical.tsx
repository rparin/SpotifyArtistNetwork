  ...
  ({ id, name, img, genres, followers, pop, url, alt }, ref) => {
    ...
    return (
      <section
        ...
        {/* Artist Music Info */}
        <header className="flex flex-col gap-2 rounded-t-md py-3 backdrop-blur-md">
          <Link
            href={netLink}
          ...
          <GenreTags
            id={id}
            items={genres}
            className="bg-slate-200/40 backdrop-blur-md dark:bg-slate-500/80"
          />
        </header>
        ...
        <Link
          ...
          <div className="flex flex-col items-center justify-center bg-slate-200/40 py-2 text-center dark:bg-slate-600/60">
            ...
            <p className="text-sm font-medium">{abbreviateNumber(followers)}</p>
          </div>
          <div className="flex flex-col items-center justify-center bg-slate-200/40 py-2 text-center dark:bg-slate-600/60">
        ...
        <footer className="rounded-b-md bg-[#1DB954] text-black">
          <Link
            href={url}
            target="_blank"
